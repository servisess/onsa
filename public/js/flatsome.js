                ...
                t.each(s.axis.split(""), function (t, e) {
                  ...
                  if (c)
                    (p[r] = c[o] + (u ? 0 : g - d.offset()[o])),
                      s.margin &&
                        ((p[r] -= parseInt(f.css("margin" + i), 10) || 0),
                        (p[r] -=
                          parseInt(f.css("border" + i + "Width"), 10) || 0)),
                      (p[r] += m[o] || 0),
                      s.over[o] &&
                        (p[r] +=
                          f["x" === e ? "width" : "height"]() * s.over[o]);
                  else {
                    var y = f[o];
                    p[r] =
                      y.slice && "%" === y.slice(-1)
          ...
          getInline: function (i, n) {
            if ((O(), i.src)) {
              ...
              if (r.length) {
                ...
                s &&
                  s.tagName &&
                  (I || ((j = o.hiddenClass), (I = C(j)), (j = "mfp-" + j)),
        ...
        reposition: function () {
          ...
          if (0 !== t("body").find(o.$tooltip).length) {
            ...
            if (
              ...
              "top-right" == L &&
                ((j = a.offset.left + a.dimension.width + O - l),
                (P = a.offset.top - c - A - 12),
                i(),
            ...
            if ("right" == L) {
              ...
              if (((P = a.offset.top - M / 2 - A), j + l > s && I < 0)) {
                ...
                j + l > s && ((j = a.offset.left - O - l - 12), (r = "right"));
            }
            if (o.options.arrow) {
    ...
    function i(t) {
      t.classList.add("parallax-active"),
        (!document
          ...
          (t.classList &&
            t.dataset &&
            (p.push({ element: t, type: a(t) }), o(p[p.length - 1])));
    }
    function n() {
          ...
          a.removeAttr("style"),
            ...
            l.length &&
              ...
              "#tab-reviews" === e
                ...
                : (n.indexOf("comment-page-") > 0 || n.indexOf("cpage=") > 0) &&
                  (l.find("a").click(),
                  jQuery.scrollTo(".reviews_tab", {
                    duration: 300,
                    offset: -150,
      ...
      attach: function (t) {
        ...
        jQuery(
          ...
          jQuery(this)
            ...
            jQuery(this).before(
              '<button class="toggle"><i class="icon-angle-' +
                t +
                '"></i></button>'
            );
        }),
